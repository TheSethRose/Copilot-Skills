...
Prompt alignment:
- For brand and visual foundations, follow `.github/prompts/brand-guidelines.skill.prompt.md`.
- For UI kit/styling work, reference `.github/prompts/tailwind.skill.prompt.md`, `.github/prompts/shadcn.skill.prompt.md`, and `.github/prompts/radix-ui.skill.prompt.md` as needed.
