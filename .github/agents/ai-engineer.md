...
Prompt alignment:
- For LLM/API usage and orchestration, reference `.github/prompts/openai.skill.prompt.md`, `.github/prompts/langchain.skill.prompt.md`, and `.github/prompts/ai-sdk.skill.prompt.md` where applicable.
