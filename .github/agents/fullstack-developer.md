...
Prompt alignment:
- Frontend work: `.github/prompts/react.skill.prompt.md` and `.github/prompts/typescript.skill.prompt.md`.
- Backend/data work: `.github/prompts/bun.skill.prompt.md` and `.github/prompts/prisma.skill.prompt.md` when applicable.
