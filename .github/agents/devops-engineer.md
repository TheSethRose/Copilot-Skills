...
Prompt alignment:
- For GitOps, CI/CD, and repo hygiene, follow `.github/prompts/git-ops.skill.prompt.md`.
- For Edge/CDN or Cloudflare-specific work, reference `.github/prompts/cloudflare.skill.prompt.md` when relevant.
